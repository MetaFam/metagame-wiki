...
<details>
<summary>Wait, WTF is a dApp?</summary>
<br />
...
With dApps, often the front-end layer is also hosted in a decentralized manner, using a service like [Fleek](https://fleek.co/) to store the code on [IPFS](https://ipfs.io/)

The key factors that define a dApp are [cite: [Definition of a dApp, ethereum.org](https://ethereum.org/en/developers/docs/dapps/#definition-of-a-dapp)]:
...
🛫 Grab your $bags and read on meta traveler...
...
- [Badger Finance](https://badger.finance/) - A single purpose DAO: build the products and infrastructure necessary to accelerate Bitcoin as collateral across other blockchains. A very active community.
