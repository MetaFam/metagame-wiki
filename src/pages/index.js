                        ...
                        >
                            <div className={"col"}>
                                ...
                                <blockquote>
                                    <p>
                                        <em>
                                            “Metagame is any approach to a game
                                            that transcends or operates outside
                                            of the prescribed rules of the game,
                                            uses external factors to affect the
                                            game, or goes beyond the supposed
                                            limits or environment set by the
                                            game.”
                                        </em>{" "}
                                        - From Wiki
                                    </p>
                                ...
                                <p>
                                    Players of MetaGame are on a quest to change
                                    the way people coordinate around solving
                                    problems &amp; creating value.
                                </p>
                                <p>
                                    The quest stretches from fixing the
                                    onboarding to the Ethereum space &amp;
                                    composing
                                    <br />
                                    the basic socio-economic infrastructure, to
                                    grappling with actual problems.
                                </p>
                                <ul>
                                    <li>
                                        You know, the opposite of the first
                                ...
                                <p>
                                    The main goal of Seed phase is to build a
                                    resource hub & a community for anyone
                                    interested in decentralized organizations
                                    &amp; applications.
                                    <br />
                                </p>
                                <p>
                                    ...
                                    &nbsp;for baking the bricks we're going to
                                    use to build the future we want to live in.
                                </p>
                                ...
                                <p>
                                    The long term goal of MetaGame is to build
                                    an alternative society; a global society
                                    focused around solving problem - not
                                    squeezing the world for profit.
                                </p>
                                <p>Building the future we want to live in:</p>
                                <ul>
                                    <li>
                                        A more collaborative, transparent &amp;
                                        decentralized future.
                                    </li>
                                    <li>
                                        A future in which human progress isn’t
                        ...
                        >
                            <div className={styles.buttons}>
                                ...
                                <Link
                                    ...
                                    to={useBaseUrl(
                                        "docs/enter-metagame/join-metagame"
                                    )}
                                >
                                    JOIN
                                </Link>
